...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BehaviorIncident.ended_at'
        db.delete_column(u'plea_behaviorincident', 'ended_at')

        # Deleting field 'BehaviorIncident.started_at'
        db.delete_column(u'plea_behaviorincident', 'started_at')

        # Deleting field 'BehaviorIncident.last_modified_at'
        db.delete_column(u'plea_behaviorincident', 'last_modified_at')

        # Adding field 'BehaviorIncident.occurred_at'
        db.add_column(u'plea_behaviorincident', 'occurred_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 24, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BehaviorIncident.ended_at'
        db.add_column(u'plea_behaviorincident', 'ended_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'BehaviorIncident.started_at'
        raise RuntimeError("Cannot reverse this migration. 'BehaviorIncident.started_at' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'BehaviorIncident.last_modified_at'
        raise RuntimeError("Cannot reverse this migration. 'BehaviorIncident.last_modified_at' and its values cannot be restored.")
        # Deleting field 'BehaviorIncident.occurred_at'
        db.delete_column(u'plea_behaviorincident', 'occurred_at')
