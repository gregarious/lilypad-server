...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chart.created_at'
        db.add_column(u'plea_chart', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Chart.last_opened_at'
        db.add_column(u'plea_chart', 'last_opened_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chart.created_at'
        db.delete_column(u'plea_chart', 'created_at')

        # Deleting field 'Chart.last_opened_at'
        db.delete_column(u'plea_chart', 'last_opened_at')
    ...
    models = {
        ...
        u'plea.chart': {
            ...
            'last_opened_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
